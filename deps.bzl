...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:AHXAl/ecNz0UglkTGd6i1VZ0I9TfqPATdVNTncZfR9M=",
        version = "v2.41.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_gin_contrib_authz",
        importpath = "github.com/gin-contrib/authz",
        sum = "h1:TpAYB4ossPFFMbnHQXrva/2S5ZTc5vrqY7lBlI5/uCc=",
        version = "v0.0.1",
    )
    go_repository(
